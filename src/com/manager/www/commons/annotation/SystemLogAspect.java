package com.manager.www.commons.annotation;  
...
public  class SystemLogAspect {  
    ...
    //Service层切点  
    @Pointcut("@annotation(com.manager.www.commons.annotation.SystemServiceLog)")  
    public  void serviceAspect() {  
    }  
  
    //Controller层切点  
    @Pointcut("@annotation(com.manager.www.commons.annotation.SystemControllerLog)")  
