		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="content/index/tables/data2.json" >
						    <thead>
						    <tr>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" id="table-style" data-url="content/index/tables/data2.json" data-row-style="rowStyle">
						    <thead>
						    <tr>
						        <th data-field="id" data-align="right" >Item ID</th>
						        <th data-field="name" >Item Name</th>
